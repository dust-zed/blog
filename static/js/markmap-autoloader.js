/*! markmap-autoloader v0.15.3 | MIT License */
...
const autoLoaderOptions = _extends$1({
  baseJs: [`d3@${"7.8.5"}`, `markmap-lib@${"0.15.3"}`, `markmap-view@${"0.15.3"}`, `markmap-toolbar@${"0.15.3"}`],
  baseCss: [`markmap-toolbar@${"0.15.3"}/dist/style.css`],
  manual: false,
  toolbar: false
